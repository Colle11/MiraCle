...
$(BIN_DIR)/miracle: $(BIN_DIR) $(SRC_DIR)/driver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/cnf_formula_gpu.o $(SRC_DIR)/sat_miracle.cuh $(BUILD_DIR)/sat_miracle.o $(BUILD_DIR)/miracle.o $(SRC_DIR)/miracle_dynamic.cuh $(BUILD_DIR)/miracle_dynamic.o $(BUILD_DIR)/miracle_gpu.o $(SRC_DIR)/launch_parameters_gpu.cuh $(BUILD_DIR)/utils.o
	$(NVCC) $(NVCCFLAGS) $(SRC_DIR)/driver.cu $(BUILD_DIR)/cnf_formula.o $(BUILD_DIR)/cnf_formula_gpu.o $(BUILD_DIR)/sat_miracle.o $(BUILD_DIR)/miracle.o $(BUILD_DIR)/miracle_dynamic.o $(BUILD_DIR)/miracle_gpu.o $(BUILD_DIR)/utils.o -o $@
